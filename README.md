...
- 商户端：经营总览、堂食订单和桌台状态工作台、快餐订单与码牌、店内/外卖订单域、区域与桌码、统一设置中心（门店、点餐、支付、通知、隐私客服、打印、员工角色）、分场景打印模板、商品/SKU/库存、分类/套餐/属性/加料/标签等配置库、顾客标签、会员等级与开卡、不可变余额流水、储值规则与记录、营销应用（优惠券/满减券、弹窗广告、免费抽奖）、可发布/回滚的小程序装修和部分退款。外卖订单入口一期仅作信息架构预留，禁止创建配送订单。
