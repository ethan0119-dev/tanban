...
- 商户端：经营总览、堂食大桌台工作台、快餐订单与码牌、店内/外卖订单域、区域与桌码、分场景打印模板、商品/SKU/库存、分类/套餐/属性/加料/标签等配置库、顾客标签、会员等级与开卡、不可变余额流水、储值规则与记录、营销应用（优惠券/满减券、弹窗广告、免费抽奖）、可发布/回滚的小程序装修、部分退款、打印机/打印任务、员工角色和每周营业时间。外卖订单入口一期仅作信息架构预留，禁止创建配送订单。
