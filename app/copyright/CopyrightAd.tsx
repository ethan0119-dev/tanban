...
import { WebsiteBrand, WebsiteFooter, WebsiteHeader } from "../WebsiteChrome";
...
export function CopyrightAd() {
  ...
  return (
    <main className="warm-site warm-inner">
      <WebsiteHeader />
      <div className="warm-copyright">
      <section className="warm-copyright__hero">
        <p>TANBAN · SMART ORDERING</p>
        <div className="warm-copyright__brand"><WebsiteBrand /><span>{copy.brand}</span></div>
        <h1>{copy.title}</h1>
        <p className="warm-copyright__lead">{copy.subtitle}</p>
        <div className="warm-copyright__pills"><span>微信点餐</span><span>营销增长</span><span>门店经营</span></div>
      </section>

      <section className="warm-copyright__section">
        <p className="warm-copyright__kicker">ONE SYSTEM · FULL JOURNEY</p>
        <h2>一套系统，连接经营全流程</h2>
        <div className="warm-copyright__grid">
      ...
      <section className="warm-copyright__quote">
        <p>“为认真经营的小店，做一套好用、耐用、看得懂的系统。”</p>
        <span>摊伴把复杂的技术留在后台，把简单顺畅的体验交给商家和顾客。</span>
      </section>

      <section className="warm-copyright__contact">
        <p className="warm-copyright__kicker">LET&apos;S TALK</p>
        <h2>想了解更多？扫码联系摊伴</h2>
        {/* QR images are administrator-provided URLs and intentionally bypass build-time image optimization. */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        {copy.qr ? <img src={copy.qr} alt="摊伴微信联系二维码" /> : <div className="warm-copyright__qr-empty">联系二维码<br />由平台后台配置</div>}
