...
func TestCreateTenantProvisionsFirstStoreAndOwner(t *testing.T) {
	...
	mock.ExpectExec("INSERT INTO tenants").
		WithArgs("WDP001", "王大鹏", "王大鹏", "13800138000", "ACTIVE", false, "", "mock", "", "").
	...
	mock.ExpectQuery("SELECT t.id,t.code,t.name").
		...
		WillReturnRows(sqlmock.NewRows([]string{
			"id", "code", "name", "contact_name", "contact_phone", "status", "cashier_enabled", "payment_provider", "payment_merchant_no", "payment_sub_appid",
		...
		}).AddRow(31, "WDP001", "王大鹏", "王大鹏", "13800138000", "ACTIVE", false, "mock", "", "", "", "", 41, "wangdapeng", "王大鹏主门店", 0, "13800138000", "王大鹏", "ACTIVE", true, "2026-07-20T10:00:00Z", "", false))
